...
/* GA helper para clicks en footer */
    ...
    <footer className="main-footer bgc-gray footer-white rel z-1">
          ...
          >
            ...
            <Link legacyBehavior href="/contact">
              <a
                ...
                onClick={() =>
                  trackEvent("footer_cta_quote_click", {
                    section: "footer_cta",
                    destination: "/contact",
                  })
                }
      ...
      <footer className="fp-footer">
        ...
        <style jsx>{`
          ...
          .fp-grid {
            display: grid;
            grid-template-columns: 1.2fr 0.8fr; /* 2 columnas */
            gap: 48px;
            align-items: start;
          }
              ...
              <div className="copyright-text text-lg-end wow fadeInLeft delay-0-2s">
                <p>
                  ...
                  <a
                    ...
                    onClick={() =>
                      trackEvent("footer_developer_link_click", {
                        label: "TAE",
                        url: "https://tecnologiasadministrativas.com",
                      })
                    }
                  >
                    TAE
                  ...
                  <a
                    ...
                    onClick={() =>
                      trackEvent("footer_developer_link_click", {
                        ...
                        url: "https://mitiendaenlineamx.com.mx/",
                      })
                    }
                  >
                    MiTiendaEnLineaMX
